module ReductionUserProfilesHelper
  ...
  #ユーザーの１日辺りの金額
  def one_day_price
    one_smoke_price * current_user.reduction_user_profile.smoking_pace
  end
  ...
  def one_every_second
    86400 / current_user.reduction_user_profile.smoking_pace
  end
  ...
  def lost_hours_money_80
    lost_time_80 * current_user.reduction_user_profile.hourly_wage
  end
end
